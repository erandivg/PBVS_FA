...
The model used for this simulation was obtained from the following repository:  
🔗 [Fully Actuated Quadrotor Model](https://github.com/FloresAlex/fully_actuated_quadrotor)  

This model was published in the following research paper:  
📄 [IEEE Xplore: Fully Actuated Quadrotor](https://ieeexplore.ieee.org/document/10155795)  
